...
def PDF_select():
    ...
    def press(button):
     if button == "Process":
            ...
            if errors:
                ...
                select_pages(src_file, page_range, Path(dest_dir, out_file))
     else:
         app.stop()
    ...
    app = gui("PDF from selected Pagese", useTtk=True)
    app.setTtkTheme("alt")
    app.setSize(500, 200)
